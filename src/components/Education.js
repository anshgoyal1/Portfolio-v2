  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="capitalize font-medium text-primary dark:text-light/75 xs:text-sm">
          {time} | {place}
        </span>
        <p className="font-medium w-full text-sm text-dark/75 xs:text-sm">
          {info}
        </p>
        <p className="font-medium w-full text-sm xs:text-sm">
